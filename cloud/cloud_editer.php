...
<div id="titre_affichage"><img onclick="afficher_fichier('<?php echo urlencode($file_name) ?>')" height="40px" src="img/cloud/precedent.png" style="float:left;"><?php

$titre = explode('/',$file_name);
echo 'Modifier '.substr( $titre[sizeof($titre)-1],0,-1-strlen ($extension));
?>

<button id="bp_editer" onclick="sauvegarder_cloud('<?php echo urlencode($file_name) ?>', '<?php echo urlencode($extension) ?>')">Sauver</button>

<span id="save_result" style="float:left; font-size:15px; line-height:40px; margin-left:10px;" ></span>
...
if($extension=='txt' ){  //********************************************************************************************************************************************
?>
  <!--div class="text_edit" id="text_editor" contenteditable="true" style="margin-bottom:10px;"><?php //echo $contenu ?></div-->

<div id="espace_affichage">
  <textarea id="text_editor" style="resize: none;" ><?php echo $contenu ?></textarea>
</div>
...
<?php
} else if( $extension=='css' || $extension=='php' || $extension=='js' || $extension=='c' || $extension=='ino' || $extension=='h' || $extension=='py' || $extension=='sh'){  //********************************************************************************************************************************************
?>
